...
public class UserInfoDetailService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        Optional<Employee> employee =employeeRepository.findByemailid(username);
        return employee.map(UserInfoDetails::new).orElseThrow(()-> new UsernameNotFoundException("User not found"));
